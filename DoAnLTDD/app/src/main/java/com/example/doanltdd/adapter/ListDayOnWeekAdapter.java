            ...
            public void onClick(View v) {
                if (groupPosition == 0) {
                    if (childPosition == 0)
                    {
                        ...
                        intent.putExtra("name", "Cơ Bản - Tuần 1 - Ngày 1");
                        context.startActivity(intent);
                    }
                    if (childPosition == 1) {
                        Intent intent = new Intent(context.getApplicationContext(), MyList.class);
                        intent.putExtra("name", "Cơ Bản - Tuần 1 - Ngày 2");
                        context.startActivity(intent);
                    }
                    if (childPosition == 2) {
                        Intent intent = new Intent(context.getApplicationContext(), MyList.class);
                        intent.putExtra("name", "Cơ Bản - Tuần 1 - Ngày 3");
                        context.startActivity(intent);
                    }
                    if (childPosition == 3) {
                        Intent intent = new Intent(context.getApplicationContext(), MyList.class);
                        intent.putExtra("name", "Cơ Bản - Tuần 1 - Ngày 4");
                        context.startActivity(intent);
                    }
                    if (childPosition == 4) {
                        Intent intent = new Intent(context.getApplicationContext(), MyList.class);
